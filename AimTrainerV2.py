...
def end_screen(win, elapsed_time, targets_pressed, clicks):
    ...
    # Accuracy calculée en utilisant tous les clics, y compris ceux qui ont raté
...
def main():
    ...
    while run:
        ...
        missed_click = click  # Initialiser à True, sera mis à False si une cible est touchée
        ...
        for target in targets:
            ...
            if click and target.collide(*mouse_pos):
                targets.remove(target)
                targets_pressed += 1
                missed_click = False  # Une cible a été touchée, donc le clic n'est pas manqué

        if missed_click:  # Si le clic a été effectué et n'a touché aucune cible
            misses += 1
